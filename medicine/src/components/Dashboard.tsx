...
import { Activity, Heart, Moon, Flame, Bell, TrendingUp, AlertTriangle, Utensils, Dumbbell, ArrowRight, ChevronRight, Pill, Clock, Plus, X } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ patientName = 'User' }) => {
  ...
  const sleepData = [
    { name: 'Deep', value: 35, color: '#6366f1' },
    { name: 'Light', value: 45, color: '#a78bfa' },
    { name: 'REM', value: 15, color: '#c4b5fd' },
    { name: 'Awake', value: 5, color: '#e9d5ff' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 pb-24 relative overflow-hidden">
      ...
      <div className="bg-gradient-to-br from-green-500 via-emerald-600 to-teal-600 text-white px-6 py-8 rounded-b-[2rem] shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-4 relative z-10">
          ...
          <button className="bg-white/20 backdrop-blur-sm p-3 rounded-full hover:bg-white/30 transition-all shadow-lg">
      ...
      <div className="px-6 -mt-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="card hover:shadow-lg transition-all">
            ...
            <p className="text-2xl font-bold text-gray-800">7h 32m</p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-4 border-2 border-yellow-200">
                    <div className="flex items-center justify-between mb-2">
                      <h5 className="font-bold text-gray-800">Breakfast (7:00 AM)</h5>
                      <span className="text-xs font-bold text-yellow-600 bg-yellow-100 px-2 py-1 rounded-full">480 cal</span>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border-2 border-green-200">
                    <div className="flex items-center justify-between mb-2">
                      <h5 className="font-bold text-gray-800">Lunch (12:30 PM)</h5>
                      <span className="text-xs font-bold text-green-600 bg-green-100 px-2 py-1 rounded-full">650 cal</span>
                    </div>
                    <ul className="space-y-1 text-sm text-gray-700">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border-2 border-blue-200">
                    <div className="flex items-center justify-between mb-2">
                      <h5 className="font-bold text-gray-800">Snack (4:00 PM)</h5>
                      <span className="text-xs font-bold text-blue-600 bg-blue-100 px-2 py-1 rounded-full">200 cal</span>
                    </div>
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li>• Greek yogurt</li>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border-2 border-purple-200">
                    <div className="flex items-center justify-between mb-2">
                      <h5 className="font-bold text-gray-800">Dinner (7:00 PM)</h5>
                      <span className="text-xs font-bold text-purple-600 bg-purple-100 px-2 py-1 rounded-full">720 cal</span>
                    </div>
                    <ul className="space-y-1 text-sm text-gray-700">
                      <li>• Baked salmon (180g)</li>
